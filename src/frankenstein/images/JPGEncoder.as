...
package frankenstein.images {
	...
	/**
	 * Evènement dispatché lorsque le BitmapData est en cours de compression 
	 *
	...
	/**
	 * Evènement dispatché lorsque le JPEG est généré 
	 *
	 ...
	 * <div class="author">
	 * <p>
	 * 		<b>Author </b> See history!<br />
	 * 		<b>Date </b> 01 jan 2009<br />
	 * 		<b>Version </b> 1.0.1<br />
	 * 		<b>History</b>
	 * 			<ul>
	 * 				<li>1.0.0 by Kyle  (<a href='http://elics.cn/kyle/projects/as3/JPGEncoder/'>http://elics.cn/kyle/projects/as3/JPGEncoder/</a>)</li>
	 * 				<li>v1.0.1 by Euegene Zatepyakin (<a href='http://blog.inspirit.ru/?p=289'>http://blog.inspirit.ru/?p=289</a>)<br />
	 * 						Added async encoding option<br />
	 ...
	 * </div>
	 * 
	 * Classe qui convertit un BitmapData en JPEG valide
	 * 
	 */
	public class JPGEncoder extends EventDispatcher {
		...
		private static const ZigZagList : IntList = IntList.create([0, 1, 5, 6,14,15,27,28,
		...
		private static const YQTList : IntList = IntList.create([16, 11, 10, 16, 24, 40, 51, 61,
		...
		private static const UVQTList : IntList = IntList.create([17, 18, 24, 47, 99, 99, 99, 99,
			...
			99, 99, 99, 99, 99, 99, 99, 99,
			99, 99, 99, 99, 99, 99, 99, 99]);
		private static const aasf : Array = [1.0, 1.387039845, 1.306562965, 1.175875602,
			1.0, 0.785694958, 0.541196100, 0.275899379];
		private static const aanscalesList : IntList = IntList.create([
			/* precomputed values scaled up by 14 bits */16384, 22725, 21407, 19266, 16384, 12873,  8867,  4520,
		...
		private static const std_ac_luminance_valuesList : IntList = IntList.create([0x01,0x02,0x03,0x00,0x04,0x11,0x05,0x12,
		...
		private static const std_ac_chrominance_valuesList : IntList = IntList.create([0x00,0x01,0x02,0x03,0x11,0x04,0x05,0x21,
		...
		private static const fltrRGB2YUV : ColorMatrixFilter = new ColorMatrixFilter([0.29900,  0.58700,  0.11400, 0,   0,
		 ...
		 *
		 * @param quality
		 * Le niveau de compression entre 1 et 100.
		 * 
		 */
		...
		/**
		 * Encode le BitmapData en JPEG.
		 *
		 * @param image
		 * Le BitmapData à encoder en JPEG.
		 * 
		 * @return
		 * Un ByteArray representant l'image au format JPEG.
		 */
		...
		/**
		 * Encode l'image en mode asynchrone empèchant le système de "friser".<br />
		 * Attention, l'appel de script pour sauvegarder l'image, 
		 * ne pourra pas se faire sur l'évènement COMPLETE : une sécurité
		 * de Flash oblige un evenement utilisateur pour accepter l'envoi
		 * 
		 * @param image
		 * Le BitmapData à encoder en JPG.
		 */
		...
		/**
		 * Encode plusieurs BitmapData à la suite
		 * 
		 * @param imgs
		 * Un tableau contenant les bitmapData à encoder.
		 * 
		 */		
		...
		/**
		 * Libère la mémoire utilisée par le JPGEncoder
		 * 
		 * @param disposeBitmapData
		 * Définit si la méthode "dispose" doit être appelée sur les BitmapData encodés.
		 * 
		 */
		public function flush(disposeBitmapData : Boolean = false) : void {
			if (asyncTimer){
				asyncTimer.stop();
		...
		/**
		 * Définit le nombre de 8x8 blocks à faire toutes les 10ms (Nombre entre 1 et 256)
		 * 
		 * @default 128
		 */
		...
		/**
		 * Retourne le ByteArray de l'image encodé en mode asynchrone
		 * 
		 */		
